...
case "$NORM_ENV" in
  "ais02"|"asintais02")
    ...
    [ -n "$TEAMS_WEBHOOK_URL_AIS02" ] && TARGET_WEBHOOKS+=("$TEAMS_WEBHOOK_URL_AIS02")
    ;;
  "apm01"|"asintapm01")
  ...
  "apm02"|"asintapm02")
    ...
    [ -n "$TEAMS_WEBHOOK_URL_APM02" ] && TARGET_WEBHOOKS+=("$TEAMS_WEBHOOK_URL_APM02")
    [ -n "$TEAMS_WEBHOOK_URL_APM02_2" ] && TARGET_WEBHOOKS+=("$TEAMS_WEBHOOK_URL_APM02_2")
    ;;
