...
if [ -n "$TEAMS_WEBHOOK_GLOBAL_1" ]; then TARGET_WEBHOOKS+=("$TEAMS_WEBHOOK_GLOBAL_1"); fi
if [ -n "$TEAMS_WEBHOOK_GLOBAL_2" ]; then TARGET_WEBHOOKS+=("$TEAMS_WEBHOOK_GLOBAL_2"); fi
if [ -n "$TEAMS_WEBHOOK_GLOBAL_3" ]; then TARGET_WEBHOOKS+=("$TEAMS_WEBHOOK_GLOBAL_3"); fi
