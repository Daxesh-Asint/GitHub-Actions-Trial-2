...
md += `| # | 📅 Date (IST) | 🌿 Snapshot Branch | 🔀 APM-02 PR | Main PR | Status | Merged APM-02? | Merged Main? | Completed? |\n`;
md += `|---|---|---|---|---|---|---|---|---|\n`;
...
for (const r of history) {
  ...
  md += `| ${r.id} | ${r.date} | \`${r.snapshot}\` | ${apm02Link} | ${mainLink} | ${r.status} | ${r.merged_apm02} | ${r.merged_main} | ${r.cycle_completed} |\n`;
}
